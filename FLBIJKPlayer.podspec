...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/fanlisheng/ijkplayer"
  ...
  spec.source = { :http => "https://github.com/fanlisheng/ijkplayer/releases/download/1.5/IJKMediaFramework.tar.gz" }
